# RUN: llvm-mc -triple=mips64el-unknown-linux -mabi=n32 -code-model=small -filetype=obj -o %T/test_ELF_N32.o %s
# RUN: llc -mtriple=mips64el-unknown-linux -mabi=n32 -filetype=obj -o %T/test_ELF_ExternalFunction_N32.o %S/Inputs/ExternalFunction.ll
...
# RUN: llvm-mc -triple=mips64-unknown-linux -mabi=n32 -code-model=small -filetype=obj -o %T/test_ELF_N32.o %s
# RUN: llc -mtriple=mips64-unknown-linux -mabi=n32 -filetype=obj -o %T/test_ELF_ExternalFunction_N32.o %S/Inputs/ExternalFunction.ll
