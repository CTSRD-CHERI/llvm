; RUN: llc < %s -march=mips64   -mabi=n64 -mcpu=mips64r2 | FileCheck %s -check-prefixes=ALL,MIPSEB
; RUN: llc < %s -march=mips64el -mabi=n64 -mcpu=mips64r2 | FileCheck %s -check-prefixes=ALL,MIPSEL
; RUN: llc < %s -march=mips64   -mabi=n32 -mcpu=mips64r2 | FileCheck %s -check-prefixes=ALL,MIPSEB
; RUN: llc < %s -march=mips64el -mabi=n32 -mcpu=mips64r2 | FileCheck %s -check-prefixes=ALL,MIPSEL
