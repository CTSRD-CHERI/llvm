...
; RUN-TODO: llc -mtriple=mips64-unknown-linux-gnu -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,SYM32,O32-BE %s
; RUN-TODO: llc -mtriple=mips64el-unknown-linux-gnu -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,SYM32,O32-LE %s

; RUN: llc -mtriple=mips64-unknown-linux-gnu -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,SYM32,NEW-BE %s
; RUN: llc -mtriple=mips64el-unknown-linux-gnu -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,SYM32,NEW-LE %s

; RUN: llc -mtriple=mips64-unknown-linux-gnu -relocation-model=static -mabi=n64 < %s | FileCheck --check-prefixes=ALL,SYM64,NEW-BE %s
; RUN: llc -mtriple=mips64el-unknown-linux-gnu -relocation-model=static -mabi=n64 < %s | FileCheck --check-prefixes=ALL,SYM64,NEW-LE %s
