...
; RUN-TODO: llc -mtriple=mips64-linux-gnu -relocation-model=static -mabi=o32 < %s | FileCheck --check-prefixes=ALL,O32 %s
; RUN-TODO: llc -mtriple=mips64el-linux-gnu -relocation-model=static -mabi=o32 < %s | FileCheck --check-prefixes=ALL,O32 %s

; RUN: llc -mtriple=mips64-linux-gnu -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,N32,N32-BE %s
; RUN: llc -mtriple=mips64el-linux-gnu -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,N32,N32-LE %s

; RUN: llc -mtriple=mips64-linux-gnu -relocation-model=static -mabi=n64 < %s | FileCheck --check-prefixes=ALL,N64,N64-BE %s
; RUN: llc -mtriple=mips64el-linux-gnu -relocation-model=static -mabi=n64 < %s | FileCheck --check-prefixes=ALL,N64,N64-LE %s
