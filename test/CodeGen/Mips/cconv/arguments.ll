...
; RUN-TODO: llc -march=mips64 -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,SYM32,O32 %s
; RUN-TODO: llc -march=mips64el -relocation-model=static -mabi=n32 < %s | FileCheck --check-prefixes=ALL,SYM32,O32 %s
