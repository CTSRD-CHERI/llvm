...
; RUN: llc < %s -march=mipsel -mcpu=mips4    -mabi=n64 -relocation-model=pic | FileCheck %s -check-prefixes=ALL,64-CMOV
; RUN: llc < %s -march=mipsel -mcpu=mips64   -mabi=n64 -relocation-model=pic | FileCheck %s -check-prefixes=ALL,64-CMOV
; RUN: llc < %s -march=mipsel -mcpu=mips64r2 -mabi=n64 -relocation-model=pic | FileCheck %s -check-prefixes=ALL,64-CMOV
; RUN: llc < %s -march=mipsel -mcpu=mips64r6 -mabi=n64 -relocation-model=pic | FileCheck %s -check-prefixes=ALL,64R6
