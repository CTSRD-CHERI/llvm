...
; RUN: llc -mtriple mipsel-unknown-linux -mcpu=mips4 -mabi n64 -relocation-model=static %s -o - | FileCheck -check-prefix=CHECK-LE64 %s
; RUN: llc -mtriple mipsel-unknown-linux -mcpu=mips4 -mabi n64 -relocation-model=pic %s -o - | FileCheck -check-prefix=CHECK-LE64_PIC %s

; RUN: llc -mtriple mipsel-unknown-linux -mcpu=mips64 -mabi n64 -relocation-model=static %s -o - | FileCheck -check-prefix=CHECK-LE64 %s
; RUN: llc -mtriple mipsel-unknown-linux -mcpu=mips64 -mabi n64 -relocation-model=pic %s -o - | FileCheck -check-prefix=CHECK-LE64_PIC %s
; RUN: llc -mtriple mipsel-unknown-linux -mcpu=mips64r2 -mabi n64 -relocation-model=static %s -o - | FileCheck -check-prefix=CHECK-LE64R2 %s
; RUN: llc -mtriple mipsel-unknown-linux -mcpu=mips64r2 -mabi n64 -relocation-model=pic %s -o - | FileCheck -check-prefix=CHECK-LE64R2_PIC %s
