...
class CheriDisassembler : public Mips64Disassembler {
public:
  CheriDisassembler(const MCSubtargetInfo &STI, const MCRegisterInfo *Info) :
    Mips64Disassembler(STI, Info, true) {}
  /// getInstruction - See MCDisassembler.
  virtual DecodeStatus getInstruction(MCInst &instr,
                                      uint64_t &size,
                                      const MemoryObject &region,
...
static MCDisassembler *createCheriDisassembler(
                       const Target &T,
                       const MCSubtargetInfo &STI) {
  return new CheriDisassembler(STI, T.createMCRegInfo(""));
}
...
DecodeStatus
CheriDisassembler::getInstruction(MCInst &instr,
                                   uint64_t &Size,
                                   const MemoryObject &Region,
                                   uint64_t Address,
                                   raw_ostream &vStream,
